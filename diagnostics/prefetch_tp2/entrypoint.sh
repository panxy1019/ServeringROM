...
STATE_DIR=/var/run/qwen36-prefetch
LOG_DIR=/var/log/qwen36-prefetch
MODEL_PATH=${MODEL_PATH:-/models/Qwen3.6-27B-w8a8}
MODEL_NAME=${MODEL_NAME:-qwen36-27b-w8a8-prefetch}
...
python3 /opt/qwen36-prefetch/discover_npu_mapping.py \
  --physical-ids 2,3 \
