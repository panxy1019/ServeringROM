            ...
            attempt_rows.append(
                {
                    ...
                    "prefill_submit_wall_ns": prefill_submit.get("ts_wall_ns") if prefill_submit else None,
                    "prefill_complete_mono_ns": _ns(prefill_complete),
                    "prefill_complete_wall_ns": prefill_complete.get("ts_wall_ns") if prefill_complete else None,
                    ...
                    "route_wall_ns": route.get("ts_wall_ns") if route else None,
                    "decode_submit_mono_ns": _ns(decode_submit),
                    "decode_submit_wall_ns": decode_submit.get("ts_wall_ns") if decode_submit else None,
                    "decode_first_byte_mono_ns": _ns(first_byte),
                    "decode_first_byte_wall_ns": first_byte.get("ts_wall_ns") if first_byte else None,
